...
# Aims
I wanted to find out more about the above claims, and aimed to plot the change in NHS doctor salaries versus changes in inflation. To this end, I wanted to create two main line plots to visualise:
...
```{r libraries}
#Loading all necessary libraries. These are taken from renv, to maintain isolation, portability, and reproducibility (this is the R Studio updated version of packrat)

renv::restore() #To restore libraries loaded for this project
